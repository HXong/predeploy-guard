...
import type { PerformanceConfigDraft, PerformanceEndpointDraft } from "../types";
import { PerformanceEndpointEditor } from "./PerformanceEndpointEditor";

type PerformanceConfigEditorProps = {
  performance: PerformanceConfigDraft;
  smokeCheckCount: number;
  onChange: (performance: PerformanceConfigDraft) => void;
};

export function PerformanceConfigEditor({ performance, smokeCheckCount, onChange }: PerformanceConfigEditorProps) {
